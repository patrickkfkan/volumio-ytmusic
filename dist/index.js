...
var _ControllerYTMusic_instances, _ControllerYTMusic_context, _ControllerYTMusic_config, _ControllerYTMusic_commandRouter, _ControllerYTMusic_browseController, _ControllerYTMusic_searchController, _ControllerYTMusic_playController, _ControllerYTMusic_nowPlayingPluginMetadataProvider, _ControllerYTMusic_getConfigI18nOptions, _ControllerYTMusic_getConfigAccountInfo, _ControllerYTMusic_getAuthStatus, _ControllerYTMusic_addToBrowseSources;
...
const NowPlayingPluginMetadataProvider_1 = __importDefault(require("./lib/util/NowPlayingPluginMetadataProvider"));
class ControllerYTMusic {
    constructor(context) {
        ...
        _ControllerYTMusic_nowPlayingPluginMetadataProvider.set(this, void 0);
    ...
    onStart() {
        ...
        __classPrivateFieldSet(this, _ControllerYTMusic_nowPlayingPluginMetadataProvider, new NowPlayingPluginMetadataProvider_1.default(), "f");
    ...
    onStop() {
        ...
        __classPrivateFieldSet(this, _ControllerYTMusic_nowPlayingPluginMetadataProvider, null, "f");
